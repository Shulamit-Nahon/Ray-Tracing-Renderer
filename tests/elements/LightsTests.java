...
public class LightsTests {
    ...
    public void FunTests() {
        scene2.geometries.add(triangle1.setMaterial(new Material().setkD(0.5).setkS(0.5).setnShininess(300)),
                       // .setEmission(new Color(java.awt.Color.BLUE)), //
                triangle2.setMaterial(new Material().setkD(0.5).setkS(0.5).setnShininess(300)));//  .setEmission(new Color(java.awt.Color.BLUE)));
    ...
    public void FunTests2() {
        scene1.geometries.add(new Sphere(70, new Point3D(0, 0, -50)).setEmission(new Color(java.awt.Color.BLUE)) .setMaterial(new Material().setkD(0.5).setkS(0.5).setnShininess(100)));
