    ...
    public void trianglesTransparentSphere() {
        ...
        scene.geometries.add( //
                new Triangle(new Point3D(-150, -150, -115), new Point3D(150, -150, -135), new Point3D(75, 75, -150)) //
                        .setMaterial(new Material().setDiffuse(0.5).setSpecular(0.5).setShininess(60)), //
                new Triangle(new Point3D(-150, -150, -115), new Point3D(-70, 70, -140), new Point3D(75, 75, -150)) //
                        .setMaterial(new Material().setDiffuse(0.5).setSpecular(0.5).setShininess(60)), //
                new Sphere(30, new Point3D(60, 50, -50)) //
                        .setEmission(new Color(java.awt.Color.BLUE)) //
                        .setMaterial(new Material().setDiffuse(0.2).setSpecular(0.2).setShininess(30).setKt(0.6)));
    ...
    public void newOne() {
        ...
        scene.geometries.add( //
                ...
                new Triangle(new Point3D(1500, -1500, -1500), new Point3D(-1500, 1500, -1500),
                        ...
                        .setEmission(new Color(20, 20, 20)) //
                        .setMaterial(new Material().setKr(1)),
                new Cylinder(new Ray(new Point3D(-950, -900, -1000), new Vector(0, 0, -1)), 400, 20)
        ...
        ImageWriter imageWriter = new ImageWriter("newTest", 500, 500);
        Render render = new Render() //
                .setImageWriter(imageWriter) //
                .setCamera(camera) //
                .setRayTracer(new RayTracerBasic(scene));
